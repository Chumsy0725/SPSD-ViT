...
def _hparams(algorithm, dataset, random_seed):
    ...
    elif algorithm == 'ERM_SPSDViT':
        _hparam('RB_loss_weight', 0.7, lambda r: r.choice([0.5, 0.1, 0.2]))
        _hparam('KL_Div_Temperature', 3.0, lambda r: r.choice([3.0, 5.0]))
        _hparam('Alpha_T', 0.8, lambda r: r.choice([0.4, 0.6, 0.8]))
